<div class="modal fade " id="modal-header" tabindex="-1" role="dialog" aria-labelledby="modal-header">
    <div class="modal-dialog modal-lg " role="document">
        <form action="{{route('usulan.store')}}" method="post" class="form-horizontal" >
            @csrf
            @method('post')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="number" class="col-sm-3 col-form-label">Nomer Urut tarif  </label>
                        <div class="col-sm-9">
                           <input type="text" name="number" id="number" minlength="2" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
