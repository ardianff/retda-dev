...
<head>
    <meta charset="UTF-8">
    <title>{{$opd->singkatan}}_Draft_Usulan_Tarif</title>
    <style>
        @page { 
...
<body class="light-mode">
    <div class="pdf-viewer">
        <div class="pdf-toolbar">
            <div class="pdf-title">{{$opd->singkatan}} Draft_Tarif</div>
                    ...
                    @foreach ($jenisTersedia as $jenis)
                        ...
                        <table>
                            ...
                            @foreach ($jenis->usulan->where('uppd_id', $b->id)->where('parent_id', 0)->where('status', 1) as $parent)
                                @include('print.draft.partials.draftpdf', ['tarif' => $parent, 'level' => 0])
                            @endforeach
