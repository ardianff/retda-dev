...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">Filter Print Draft Usulan Tarif</div>
            <div class="card-body">
                <form action="{{route('print.draftexport')}}" method="get" target="_blank">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row mb-1">
                                <label for="" class="col-md-2 ">Pilih Pengajuan</label>
                                <div class="col-md-6">
                                    <select id="pengajuan_id" class="form-control " name="pengajuan_id" required>
                                        @foreach ($pengajuan as $item)
                                        
                                        <option   value="{{$item->id}}">Tahun {{$item->deskripsi}}</option>
                                        @endforeach
                    ...
                    @if (userSpesial())
                                ...
                                @endif
                                            ...
                                            <button type="submit" name="action" value="unduhPDF" class="btn btn-info btn-sm " target="_blank">
