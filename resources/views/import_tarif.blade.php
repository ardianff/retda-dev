...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            Import Tarif</div>
            <div class="card-body">
                <form action="{{ route('import_tarif.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="file" class="col-md-3 ">Upload File txt</label>
                                <div class="col-md-9">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label for="" class="col-md-4 ">Rekening Retribusi</label>
                                <div class="col-md-8">
                                    <select id="rekening_id" class="form-control " name="rekening_id" required>
                                        <option value=""></option>
...
<div class="card">
    <div class="card-body">
        <form id="importUsulan" action="{{ route('importUsulan') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group row">
                <label for="file" class="col-md-3 ">Upload File excel</label>
                <div class="col-md-9">
                    <input type="file" class="form-control" name="usulan" required>
                </div>
            </div>
            <button type="submit" class="btn btn-success btn-sm btn-flat">Save <i class="fas fa-save fa-md"></i></button>
        </form>
