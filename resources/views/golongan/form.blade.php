        ...
        <form action="" method="post" class="form-horizontal" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label for="name" class="col-sm-3 col-form-label">Golongan </label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label for="id_sipenari" class="col-sm-3 col-form-label">id sipenari  </label>
                        <div class="col-sm-9">
                            <input type="text" name="id_sipenari" id="id_sipenari" class="form-control" >
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="grms_id" class="col-sm-3 col-form-label">id GRMS  </label>
                        <div class="col-sm-9">
